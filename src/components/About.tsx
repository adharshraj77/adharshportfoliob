...
import { MapPin, Brain, Award, Mail, User, Code, Target,School,GraduationCap} from 'lucide-react';
...
export default function About() {
  ...
  const stats = [
    ...
    { icon: GraduationCap, label: "Specailization", value: "AI & ML + DataScience", color: "green" },
